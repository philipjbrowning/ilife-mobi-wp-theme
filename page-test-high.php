		...
		<div id="container" class="align_left width_full">
        	<div id="content">
				...
				<section id="main" class="margin_left_200px">
                	<?php if ( have_posts() ): ?>
                    <h2>Test High Price</h2>
                    <?php the_content(); ?>
                    <?php endif; ?>
<?php
$results = $wpdb->get_results("SELECT item_ID, MAX(price) AS max_price, price_date
...
if ($results !== false) {
	foreach ( $results as $result ) 
	{
		...
		echo "<p>max_price = $".$result->max_price."</p>";
